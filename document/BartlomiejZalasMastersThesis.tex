...
THREADS & T20     & Application server will use 20 threads\\ \cline{2-3}
        & T50     & Application server will use 50 threads\\ \cline{2-3}
        & T80     & Application server will use 80 threads\\ \hline
\end{tabularx}
\end{table}	
...
The initial configuration provided by the \textit{Configuration Service} during the experiments evaluating the APTS presented in the Table \ref{cacheinitconf}. As presented, by default cache and batch are disabled, the application server threads number is set to 50. 
...
\section{System evaluation measurements - cache} \label{appendixcacheeval}
...
\begin{tabular}{c| C{1.5cm}  C{1.5cm}  C{1.5cm} |c}
    ...
    Sample \# & Cached & No Cache & Adapted &\\ \cline{1-4}
    1		  &22.00 & 21.50  & 20.20 &\\ 
    2		  &20.27 & 20.51  &	20.63 &\\ 
    3		  &21.70 & 22.23  &	19.50 &\\ 
    4		  &19.67 & 19.90  & 20.04 &\\ 
...
\begin{tabular}{c| C{2cm}  C{2cm} |c}
    ...
    Sample \# & No Cache & Cached  &\\ \cline{1-3}
    1		  &56.27 & 33.25  &\\ 
    2		  &50.83 & 33.86  &\\ 
    3		  &61.59 & 43.07  &\\ 
    4		  &48.26 & 44.61  &\\ 
...
\begin{tabular}{c| C{1.1cm}  C{1.2cm}  C{1.1cm}|C{1.1cm} C{1.2cm} C{1.1cm} |c}
    ...
    Sample \# & Phase I & Phase II & Total & Phase I & Phase II & Total &\\ \cline{1-7}
